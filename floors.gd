...
var fall_floor = preload("res://obstacle_floors/fall_floor.tscn")
var obs_floor = preload("res://obstacle_floors/obstacle_floor.tscn")
var normal_floor = preload("res://normal_floor.tscn")
var spawn_enemies_dash = preload("res://spawn_enemies_dash.gd")
