...
@onready var attack_c_player = preload("res://player_control/attack_c_player.gd")
@onready var dodge_c_player = preload("res://player_control/dodge_c_player.gd")
@onready var movement_c_player = preload("res://player_control/movement_c_player.gd")
@onready var coin_c_player = preload("res://player_control/coin_c_player.gd")
@onready var health = preload("res://player_control/player_health.gd")
