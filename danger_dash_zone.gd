...
var danger_arrow_img = preload("res://triangle.png")
var to_red = preload("res://to_red.gdshader")
var danger_zone
...
func _init(_parent, collision):
	...
	parent.add_child(danger_zone_cooldown_bar)
	danger_zone.z_index = -1
	danger_zone_cooldown_bar.z_index = -1
	
	var danger_arrow = TextureRect.new()
